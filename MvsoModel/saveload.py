...
def save(prob, filename):
    """Save MvsoModel model input and result cache to a HDF5 store file.

    Args:
        prob: a MvsoModel model instance containing a solution
...
def load(filename):
    """Load a MvsoModel model result container from a HDF5 store file.
