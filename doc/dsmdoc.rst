...
Demand Side Management (DSM) is a plug-in feature to the energy model MvsoModel. 
...
formulation and the DSM feature of MvsoModel are explained.


Introduction
------------

The DSM feature of MvsoModel has 2 variables **DSM upshift** and **DSM downshift**. 
...
The input excel file of MvsoModel requires an extra DSM sheet, with columns named 
these parameters. This sheet allows DSM to be incorporated in MvsoModel. The DSM feature 
...
After the mathematical description of the DSM feature in MvsoModel, running some example 
