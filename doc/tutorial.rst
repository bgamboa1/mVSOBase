...
.. __: https://github.com/tum-ens/MvsoModel/blob/master/README.md#installation
...
* `MvsoModel`_ is the module whose functions are used mainly in this script. These
...
The :func:`MvsoModel.report` function creates a spreadsheet from the main results.
...
.. _MvsoModel.py: https://github.com/tum-ens/MvsoModel/blob/master/MvsoModel.py
